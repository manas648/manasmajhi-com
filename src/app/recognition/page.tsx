          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-3 gap-px border border-border rounded-lg overflow-hidden mt-6">
              <div className="bg-muted/30 px-6 py-5">
                <p className="font-serif text-3xl font-medium">3.2K</p>
              ...
              <div className="bg-muted/30 px-6 py-5">
                <p className="font-serif text-3xl font-medium">16</p>
                <p className="text-xs uppercase tracking-widest text-muted-foreground mt-1">
                  Avg. cited pages
                </p>
              </div>
            ...
            <div className="rounded-lg overflow-hidden border border-border mt-2">
              <Image
                ...
                alt="Microsoft Bing Webmaster Tools — AI Performance dashboard showing 3.2K total citations and 16 average cited pages for majhigroup.com over the last 30 days, sourced from Microsoft Copilots and Partners"
                width={2880}
                height={1276}
                className="w-full h-auto"
                loading="lazy"
