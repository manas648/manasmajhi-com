  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    },
    {
      ...
      images: [
        ...
        `${SITE_URL}/elsewhere/kolsai-lake.jpg`,
        `${SITE_URL}/elsewhere/horse-rider.jpg`,
        `${SITE_URL}/elsewhere/charyn-valley.jpg`,
        `${SITE_URL}/elsewhere/shymbulak-snow.jpg`,
        `${SITE_URL}/elsewhere/charyn-canyon.jpg`,
        `${SITE_URL}/elsewhere/almaty-cafe.jpg`,
        `${SITE_URL}/elsewhere/medeu-arena.jpg`,
        `${SITE_URL}/elsewhere/almaty-tv-tower.jpg`,
