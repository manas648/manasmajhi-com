...
const readingPaths = [
  ...
  },
  {
    title: "Odisha",
    description:
      "Development, talent, and the untapped potential of a remarkable state.",
    href: "/odisha",
  ...
  },
  {
    ...
    description:
      "Building things, executing with conviction, thinking long-term.",
  ...
  },
  {
    title: "Frameworks",
    description:
      "Mental models for thinking about opportunity and human potential.",
    href: "/frameworks",
...
const placesHubs = [
  {
    ...
    title: "India",
    description:
      "Why India's moment is now. Technology, talent, and what's being built.",
    href: "/india",
    category: "india" as EssayCategory,
  },
  {
    ...
    title: "Odisha",
    description:
      "The most differentiated state in India. Economy, talent, cities, and opportunity.",
    href: "/odisha",
    category: "odisha" as EssayCategory,
  },
  {
    ...
    title: "Kalahandi",
    description:
      "Where I come from. What a place most people haven't heard of taught me about opportunity.",
    href: "/kalahandi",
    category: "kalahandi" as EssayCategory,
  },
];
...
const socialProof = [
  {
    label: "World Staffing Leader",
    org: "Staffing Industry Analysts",
    href: "/entrepreneurship/world-staffing-leader",
  },
  {
    label: "Indian Achievers Award",
    org: "Indian Achievers Forum",
    href: "/entrepreneurship/indian-achievers-award-2022",
  },
  {
    label: "Startup of the Year",
    org: "HackerNoon 2023",
    href: "/entrepreneurship/hackernoon-startup-of-the-year-2023",
  },
];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr,auto] gap-12 lg:gap-20 items-center">
            ...
            <div className="max-w-2xl">
              ...
              <p className="text-base md:text-lg text-muted-foreground leading-relaxed mb-4 max-w-2xl">
                A Kalahandi-born entrepreneur writing about how talent,
                opportunity, technology, and development intersect in Odisha,
                India, and the world.
              </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1fr,auto] gap-12 items-start">
              ...
              <div className="max-w-2xl">
                ...
                <p className="text-muted-foreground text-lg leading-relaxed mb-4">
                  ...
                  What I built there was a habit of figuring things out
                  without the infrastructure that makes figuring things out
                  easy.
                </p>
              ...
              <div className="lg:min-w-[220px] space-y-6">
                {[
                  {
                    label: "Indian Achievers Award",
                    sub: "Entrepreneur of the Year · 2022",
                  },
                  {
                    label: "World Staffing Leader #18",
                    sub: "Global Top 100 · 2024",
                  },
                  {
                    label: "World Staffing Leader #87",
              ...
              <div className="relative rounded-3xl overflow-hidden border border-border">
                ...
                <div
                  className={
                    heroEssay.coverImage
                      ? "p-8 md:p-12"
                      : "bg-gradient-to-br from-muted/50 to-background p-8 md:p-12 lg:p-16"
                  }
                >
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {placesHubs.map((place) => {
              const placeCount = allEssays.filter(
                (e) => e.category === place.category
              ).length;
