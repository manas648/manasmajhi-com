...
faqs:
  - question: "How large is Paradip Port?"
    answer: "Paradip Port Trust (now Paradip Port Authority) is one of India's major ports and consistently ranks among the top two by cargo volume. It handles over 130 million metric tonnes of cargo annually, making it the second-largest major port in India by total throughput. The port handles bulk cargo — primarily iron ore, coal, fertilizers, and crude oil — rather than container traffic, which is why it is less known despite its scale."
