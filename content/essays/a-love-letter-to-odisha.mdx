...
It also has persistent poverty metrics that put it among the lower half of Indian states, a [talent outflow](/writing/talent-is-evenly-distributed) that takes its most educated people to Bangalore, Hyderabad, and Pune, and an institutional capacity that has improved but lags what the state's natural and human endowments should have produced.

This gap — between what Odisha is and what it [could be](/writing/the-future-of-odisha) — is the central tension I carry from having grown up there.
