...
faqs:
  ...
  - question: "How does the information gap compound over time?"
    answer: "Each iteration widens the gap, not through differential effort, but through differential information. This is why solving the information gap requires changing the ongoing flow, not making one disclosure more available."
