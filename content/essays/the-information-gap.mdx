...
coverImage: /Essay Pictures/the-information-gap.jpg
tags: ["opportunity", "information", "access", "systems", "inequality"]
featured: false
flagship: false
faqs:
  - question: "What is the invisible asymmetry in information and why does it matter?"
    answer: "Most information that shapes life outcomes — the real selection criteria behind job postings, which application deadlines matter, which experiences to foreground for which roles — is never formally published. It travels through networks: alumni groups, family connections, people who have been in the room. Inside these networks you move through the world with a significant informational advantage. Outside them, you make correct effort on incomplete data."
  - question: "How does the information gap compound over time?"
    answer: "The person who knows about an opportunity applies and, if successful, enters an environment that gives them more information about the next opportunity. The person who does not know gains no access and no subsequent information advantage. Each iteration widens the gap — not through differential effort, but through differential information. This is why solving the information gap requires changing the ongoing flow, not making one disclosure more available."
  - question: "What three interventions actually address the information gap?"
    answer: "Access to people who have done the thing — not formal mentorship, just existing in your environment and being willing to be direct about what they found. Transparency from institutions — publishing the informal knowledge they currently transmit only through networks. And first-movers who transmit what they learned to those who come after. The most effective interventions deliver the information rather than advising people to seek it."
---
When I was trying to understand how executive search worked as a business, I had access to almost no useful information. There were no courses. The books that existed were too general. The people who knew how the business actually worked — how to price, how to source, how to negotiate — were competitors, not collaborators. I built most of my early understanding through trial, error, and a few conversations with people who were generous enough to be direct with me.
...
**See also:** [How Opportunity Compounds Over Time](/opportunity/how-opportunity-compounds), [Networks Are Not Networking](/opportunity/networks-are-not-networking), [Opportunity Gaps — Where They Exist and Why](/opportunity/opportunity-gaps)
