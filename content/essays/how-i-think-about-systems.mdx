...
date: "2024-12-15"
category: "philosophy"
coverImage: https://images.unsplash.com/photo-1558025623-2aafbebe8daf?w=1200&q=80&auto=format&fit=crop
tags: ["systems", "philosophy", "thinking", "frameworks", "mental models"]
featured: false
flagship: false
faqs:
  - question: "What are the two features of systems that most consistently trip people up?"
    answer: "Feedback loops, where outputs become inputs, creating self-reinforcing dynamics that compound early differences into large later divergences. And delay, where cause and effect are separated in time, meaning by the time you see the output of a decision, the decision is old and the connection between the two is non-obvious. Together, these make it genuinely hard to reason about systems using the linear logic that works for component-level problems."
  - question: "Why does fixing individual components rarely fix system output?"
    answer: "Because the output is a product of the structure, how components interact, not just the components themselves. A system with a structural failure mode will produce bad outputs even when each individual component is functioning correctly. Fixing the components while leaving the structure intact produces temporary improvement at best. The fix that works is the one that changes the structure that generates the bad output."
  - question: "How did systems thinking shape the design of Majhi OS?"
    answer: "It reframed the diagnosis of why searches fail. The conventional view is a supply problem: not enough good candidates. The systems view is that searches fail because the process has structural failure modes, ambiguous intake, unclear evaluation criteria, misaligned incentives, that produce bad outputs even when supply is adequate. Fix the structure and the same candidate pool produces dramatically better results. Majhi OS is built on the insight that the system is the problem, not the inputs."
---
...
>> The problem keeps returning after it's been fixed? You haven't fixed the system. You've addressed a symptom. The structure that produces the symptom is intact.
...
**See also:** [How I Think About Learning](/philosophy/how-i-think-about-learning), [Books That Changed My Thinking](/philosophy/books-that-changed-my-thinking), [How to Make Decisions When You Don't Have Enough Information](/philosophy/decisions-under-uncertainty), [What I Believe, Core Worldview](/philosophy/what-i-believe)
...
[Jay Forrester: Industrial Dynamics (MIT Press)](https://mitpress.mit.edu/9780915299881/industrial-dynamics/)
