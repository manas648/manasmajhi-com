...
coverImage: https://images.unsplash.com/photo-1758518730264-9235a1e5416b?w=1200&q=80&auto=format&fit=crop
tags: ["opportunity", "systems", "design", "institutions", "human potential"]
featured: false
flagship: false
faqs:
  - question: "What distinguishes an education system that develops capability from one that merely sorts for prior advantage?"
    answer: "A sorting system accelerates people who were already ahead, treating prior advantage as merit. A development system takes raw capability and builds it regardless of starting conditions: providing the scaffold that prior advantage would otherwise supply: implicit knowledge, networks, bridges across information gaps. The most effective institutions require genuine capability but invest in developing it rather than just measuring it."
  - question: "What two conditions must a labour market meet to create opportunity rather than just reproduce existing advantage?"
    answer: "Information: candidates need to know opportunities exist and employers need to see candidates beyond their existing networks. And mobility: candidates must actually be able to accept the opportunity, whether that means geographic mobility (financially possible), social mobility (not penalised by community), or regulatory mobility (credentials that transfer). Block either and the market fails at opportunity creation even when opportunities technically exist."
  - question: "Why is state capacity described as the meta-system behind all opportunity creation?"
    answer: "Because all other opportunity-creating systems depend on it. Education systems require public investment and accountability mechanisms. Labour markets need enforceable contracts and anti-discrimination enforcement. Financial systems need regulatory frameworks that enable trust. Infrastructure is the literal platform on which all economic activity runs. The countries and regions with the highest opportunity creation consistently have the highest state capacity, not coincidentally but causally."
---

Majhi Group closed its first international search because of one specific decision made two years before it: I joined a professional association I had no immediate use for, showed up consistently for a year, and eventually met someone who introduced me to a client based outside India. The system that created that opportunity, the structure of the association, the norms it enforced, the credibility it conferred, was not accidental. Someone had designed those mechanisms deliberately.
...
Talent is evenly distributed. Systems are what decide whether it ever becomes opportunity.
...
>> Capital is opportunity in deferred form. The person who cannot borrow anything - because they lack collateral, because they lack credit history, because the formal financial system is inaccessible - cannot access the same opportunity even if they have identical capability and desire.
...
**See also:** [How Opportunity Compounds Over Time](/opportunity/how-opportunity-compounds), [Opportunity Changes Lives](/opportunity/opportunity-changes-lives), [What Is Opportunity?](/opportunity/what-is-opportunity)
...
[McKinsey Global Institute: India's Labor Market](https://www.mckinsey.com/featured-insights/india)
