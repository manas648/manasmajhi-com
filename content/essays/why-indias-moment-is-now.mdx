...
>> The demographic dividend does not last. The geopolitical alignment does not last. The infrastructure investment is being made now, and what gets built now constrains what is possible later. The window is real. So is the cost of not using it.
