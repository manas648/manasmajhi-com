...
faqs:
  - question: "What is the most underrated innovation in India, and why is it underrated?"
    answer: "UPI — the Unified Payments Interface — is the most underrated innovation in India's recent technology history. It processed 172 billion transactions in 2024, growing 46% year-on-year, and in peak months has exceeded the combined digital transaction volumes of Visa and Mastercard globally. It is underrated because most technology coverage focuses on the apps built on top of it (PhonePe, Google Pay, Paytm) rather than the infrastructure those apps run on. The innovation is not the app. It is the design decision to build payment infrastructure as a public good — open, interoperable, owned by no single company."
...
UPI processed [172 billion transactions in 2024](https://www.npci.org.in/product/upi/product-statistics) — growing 46% year-on-year — reaching 16.73 billion in December alone. The apps that ride on it are well-known. The infrastructure underneath them is the actual story.

>> The most significant Indian innovation of the past decade is not a startup. It is a set of design decisions made by a small number of people in government about how to build shared infrastructure that would eventually enable a generation of products. No single company owns the network — which means no single company can extract rents from access to it or optimize it at the expense of the overall system.
