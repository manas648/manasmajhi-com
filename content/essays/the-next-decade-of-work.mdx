...
>> When the cost of producing a first draft drops to near-zero, the value of judgment about which first drafts are worth developing rises. When information synthesis becomes cheaper, the value of knowing which questions to ask and why rises. The meta-skill is judgment — operating effectively in situations that are not fully specified.
