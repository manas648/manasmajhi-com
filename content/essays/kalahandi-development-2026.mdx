...
>> Capability is present in Kalahandi in ways that the statistics don't capture — because the statistics measure outcomes, and the people of Kalahandi have been systematically denied the opportunity structures that would translate capability into outcomes.
