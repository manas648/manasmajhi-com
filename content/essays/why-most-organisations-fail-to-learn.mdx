...
excerpt: "Organisational learning is harder by an order of magnitude, because organisations don't learn the way people do. They need infrastructure to learn at all. Most never build it."
date: "2026-06-30"
...
>> The learning requires infrastructure to survive: to be captured, stored, transmitted, and applied by people who weren't there for the original experience.
...
and transmitted to the next recruiter who faces a similar situation, without requiring that recruiter to have been there for the original experience or to have a manager who happens to remember it.
