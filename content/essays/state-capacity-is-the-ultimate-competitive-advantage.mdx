...
featured: false
flagship: false
coverImage: https://images.unsplash.com/photo-1504244648668-89000185ea9b?auto=format&fit=crop&w=1200&h=600&q=80
---
...
## India's state capacity gap — the terrain covered in [what good policy actually looks like](/writing/what-good-policy-actually-looks-like)

India's development story is partly a story about the gap between policy ambition and execution capacity.

India has produced [policy frameworks](/writing/what-good-policy-actually-looks-like) of considerable sophistication — on infrastructure, on financial inclusion, on education, on health. It has some institutions of genuine excellence — parts of the civil service, ISRO, a generation of IITs that produced world-class engineers. And it has serious state capacity gaps that are visible in the outcomes.
...
The interesting thing about India's recent development trajectory is how much of it has been achieved by routing around the state capacity constraint rather than solving it. [Digital payment infrastructure](/writing/digital-public-infrastructure) replaced the need for physical banking presence. Aadhaar-based direct benefit transfers reduced the leakage in welfare delivery by changing the transaction structure. Technology solutions that achieve policy objectives without requiring the same intensity of bureaucratic capacity to operate.
