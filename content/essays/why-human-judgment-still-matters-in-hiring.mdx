...
>> The assessment that determines whether an executive placement succeeds is irreducibly subjective — but not arbitrary. Subjective means it depends on a subject: an experienced professional who has been wrong, learned from being wrong, and developed a more calibrated instinct over time. AI has pattern matching. That is not the same thing.
