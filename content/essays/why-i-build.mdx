...
When I started in executive search, I kept running into the same problem. The systems we used to find, evaluate, and place senior leaders were worse than they needed to be. Not because people weren't trying. But because nobody had built the infrastructure to make them better.
