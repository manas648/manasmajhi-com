...
featured: false
flagship: false
coverImage: https://images.unsplash.com/photo-1563636390022-d3c262f3004c?auto=format&fit=crop&w=1200&h=600&q=80
---

Every country has an abundance of good policy analysis — and India's [digital public infrastructure](/writing/digital-public-infrastructure) is one of the rare cases where that analysis actually got executed at scale. Think tanks, academics, consultants, and former officials produce an enormous quantity of well-researched recommendations for how governments should address problems. Almost none of it gets implemented. Of the small fraction that does, a smaller fraction still gets implemented in ways that actually produce the intended outcomes.

The bottleneck in development is not the quality of policy thinking. It is the [capacity to turn thinking into outcomes](/writing/state-capacity-is-the-ultimate-competitive-advantage) through real institutions with real constraints.
