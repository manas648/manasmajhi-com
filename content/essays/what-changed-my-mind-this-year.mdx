...
date: "2024-08-03"
category: "philosophy"
coverImage: https://images.unsplash.com/photo-1767634559332-b0726f663cf9?w=1200&q=80&auto=format&fit=crop
tags: ["philosophy", "learning", "beliefs", "updating"]
featured: false
flagship: false
faqs:
  - question: "Why is consensus an unreliable proxy for confidence?"
    answer: "Because consensus can be produced by social pressure toward alignment rather than by independent analysis. These produce superficially identical outcomes — everyone agrees — and very different reliability. A room where people converge because each independently reached the same conclusion is genuinely informative. A room where people converge because disagreement is uncomfortable is not. The relevant question is always which mechanism produced the agreement."
  - question: "What update happened about what ambitious people actually need?"
    answer: "The previous belief was that ambitious people primarily needed better opportunity — better access to roles, networks, and resources. What changed the view was working closely with people who had access and still did not reach the outcomes they were capable of. The limiting factor was not structural but internal — patterns of response to difficulty that were adaptive in earlier contexts and had stopped being so. The most important interventions for capable people are not just access-creating but capacity-building."
  - question: "What was the meta-update about Manas's own diagnostic framework?"
    answer: "That his lenses — models for why things work and why they fail — are built from a specific set of experiences in specific contexts, and they produce systematic blind spots in situations that don't fit those contexts. The update is not to distrust the lenses but to use them as hypotheses rather than conclusions — to stay in the question longer before arriving at the diagnosis. The lenses point somewhere useful. They do not always point exactly right."
---
...
>> Consensus is a proxy for confidence, but not a very reliable one. The relevant question is not "do people agree?" but "are the people agreeing from independent analysis, or from social pressure toward alignment?" These produce superficially identical outcomes and very different reliability.

**See also:** [Books That Changed My Thinking](/philosophy/books-that-changed-my-thinking), [How I Think About Learning](/philosophy/how-i-think-about-learning), [The Evolution of My Thinking](/philosophy/the-evolution-of-my-thinking)
