...
>> The only argument that works with human nature is not the argument. It is the demonstration. On that Sunday from a hilltop in Kalahandi, we were putting the district on the world stage — not by arguing that it deserved to be there, but by demonstrating it.
