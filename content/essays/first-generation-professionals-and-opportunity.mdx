...
coverImage: https://images.unsplash.com/photo-1705234384679-119488a72a2b?w=1200&q=80&auto=format&fit=crop
tags: ["opportunity", "first-generation", "social mobility", "career", "Kalahandi"]
featured: false
flagship: false
faqs:
  - question: "What are the actual advantages of being a first-generation professional?"
    answer: "Better calibration of real risk: you have seen genuine failure, not just missed targets. Deeper motivation, because you are not just advancing a career but proving the whole project viable. And adaptability from having already crossed significant cultural contexts before entering professional life. The deficit framing misses all of this."
  - question: "Why do first-generation professionals often advance more slowly despite comparable performance?"
    answer: "Primarily because of the gap between inherited and built networks. Professional families transfer decades of relationship capital to their children automatically. First-generation professionals build all of it from scratch, which is possible but slower and dependent on specific generous individuals. The performance gap is not the issue; the structural foundation beneath performance is."
  - question: "What is the first-generation tax and who bears it?"
    answer: "It is the ongoing cost of being the financial backstop for a broader family network, loans, medical expenses, sibling education, housing, alongside the emotional weight of carrying family hopes in a way that makes professional setbacks feel categorical rather than personal. It is not resentment; it is a structural constraint that limits capital available for personal investment and risk-taking."
---
I grew up in a family where my father worked in government administration and my mother was a schoolteacher. Nobody in my family had been in executive search. Nobody had built a business across multiple countries. When I started, I did not have the network, the reference points, or the vocabulary that comes standard for people whose parents had already been in the professional world I was trying to enter. I had to build all of it from first principles.
...
**See also:** [How to Create Opportunity for Others](/opportunity/how-to-create-opportunity-for-others), [Networks Are Not Networking](/opportunity/networks-are-not-networking), [Opportunity Gaps: Where They Exist and Why](/opportunity/opportunity-gaps)
