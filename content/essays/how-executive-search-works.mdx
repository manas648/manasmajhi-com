...
faqs:
  - question: "What is the difference between retained executive search and contingency search?"
    answer: "In retained search, the firm is engaged exclusively and paid in stages regardless of outcome, typically one-third upfront at engagement, one-third at shortlist, and one-third at placement. This aligns the firm's incentives with finding the right person: they work the search whether or not they place someone, and are paid for process quality, not placement speed. In contingency search, multiple firms work simultaneously and only the placing firm gets paid. This creates incentives toward speed over quality, firms are motivated to submit candidates quickly before competitors do, not to qualify them carefully. For VP and C-suite roles, retained search is the standard for firms genuinely committed to outcome quality."
  - question: "What are the stages of a retained executive search?"
    answer: "A retained executive search moves through five stages. First, the brief: a structured intake session where the search team builds the internal document driving the search, business context, success criteria, compensation structure, evaluation framework. Second, market research: mapping who exists at the relevant level and understanding the competitive landscape for this hire. Third, outreach and qualification: approaching target candidates, identifying those who are interested and qualified, and conducting initial conversations. Fourth, shortlisting: presenting four to six candidates with detailed briefing notes and the search team's assessment. Fifth, close: supporting final interviews, reference checks, offer construction, and negotiation."
  - question: "How do executive search firms find candidates that LinkedIn and job boards miss?"
    answer: "Executive search finds candidates passive sourcing misses through three mechanisms. First, direct outreach to people who are not actively searching, the best candidates for most VP and C-suite roles are currently employed and not on job boards. Search firms approach them directly with a specific, well-constructed pitch. Second, relationship networks, consultants with deep networks in specific functions have access through warm introductions that algorithmic sourcing doesn't surface. Third, market intelligence, knowing who is performing at a high level inside a specific type of company, even when that performance isn't publicly visible. This last mechanism is what distinguishes an experienced search consultant from a well-deployed AI sourcing tool."
---

I have run VP and C-suite searches across India, the UK, and the Middle East for over five years. The most consistent pattern: searches go wrong not because of a shortage of candidates, but because of a breakdown somewhere in the process that the client couldn't see, because no one explained what the process was supposed to look like before it started. The mechanics matter. Here is what they are.
...
>> The brief is the most consequential document in the search. A brief that takes two hours to produce carefully will save weeks later. A brief that is rushed or vague will produce a search that meanders.
...
**See also:** [41 Days. $275K Search. Two Firms Failed.](/hiring/forty-one-days), [How to Evaluate Executive Candidates](/hiring/how-to-evaluate-executive-candidates), [The Difference Between Retained and Contingency Search](/hiring/retained-vs-contingency-search)
