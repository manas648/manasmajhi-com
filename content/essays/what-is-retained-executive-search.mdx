...
When CEOs ask how I work, I give them the short version first: I take a retainer up front, I work exclusively on your search, and I take full accountability for the outcome — not just the shortlist, but the close. If the hire doesn't work in 90 days, I run the search again at no charge. That model is retained executive search. Here is what it means in practice.
