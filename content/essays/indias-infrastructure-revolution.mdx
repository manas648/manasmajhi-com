...
faqs:
  ...
  - question: "What has UPI's growth revealed about India's digital infrastructure build?"
    answer: "UPI is the clearest measure of digital infrastructure success. Launched in 2016, it processed over 172 billion transactions in 2024 — growing 46% year-on-year — and in peak months has exceeded the combined digital transaction volumes of Visa and Mastercard globally. The architecture — interoperable, real-time, effectively free for users — was a deliberate design choice that no single company could have built with the same incentive structure."
...
**UPI**: the [Unified Payments Interface, launched by NPCI in 2016](https://www.npci.org.in/product/upi/product-statistics), processed 172 billion transactions across all of 2024 — growing 46% year-on-year — reaching 16.73 billion in December 2024 alone. To contextualise: it processes more retail digital transactions than Visa globally. It took eight years to build a payment system that reaches from Mumbai's financial district to a vegetable vendor in Kalahandi. The architecture — interoperable, real-time, effectively free for users — was a deliberate design choice, not a market outcome. It did not happen automatically.
