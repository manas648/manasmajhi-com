...
excerpt: "The things that actually change how you build never come from a playbook. They come from a specific deal that fell through, a hire that turned out to be wrong, a market that moved before you were ready. The lesson doesn't transfer — the scar does."
date: "2022-04-28"
category: "entrepreneurship"
coverImage: https://images.unsplash.com/photo-1758876020406-0edb3631d5f1?w=1200&q=80&auto=format&fit=crop
tags: ["entrepreneurship", "founders", "building", "lessons"]
featured: false
flagship: false
---

The lesson I most needed as a founder arrived while I was on a call with a client whose delivery I thought I'd mismanaged. Forty minutes in, I realized I hadn't mismanaged the delivery — I'd misscoped the engagement three months earlier and hadn't seen it. Every problem that followed was downstream of that one.
...
>> A mediocre idea executed with sustained commitment and honest learning will almost always beat a brilliant idea executed without those things.
