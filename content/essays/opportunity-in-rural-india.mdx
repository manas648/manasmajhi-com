...
flagship: false
faqs:
  - question: "What does rural actually mean in terms of opportunity?"
    answer: "Primarily, distance from the institutions that create and distribute opportunity, not always physical distance, but effective isolation. This produces three compounding effects: information scarcity (the paths that exist aren't visible), institutional thinness (schools exist but quality varies enormously), and cost amplification (the same cost barrier becomes categorically different for a farming family in a drought year versus an urban family)."
  - question: "What has genuinely changed for rural opportunity in the last decade?"
    answer: "Mobile penetration has reached most of rural India, which is really a mobility story, since information is the first requirement for opportunity. Road connectivity has improved substantially under PMGSY. The first generation who used mobile internet to discover possibilities is now entering their twenties, and the compounding returns on that information access are just beginning."
  - question: "Why is the gap between infrastructure improvement and actual outcome shifts slower than expected?"
    answer: "Because the information gap and social constraints, gender norms, caste access, the absence of first-movers demonstrating the path is real, are not addressed by physical infrastructure. Roads and internet access enable more than they automatically deliver. The human infrastructure that translates physical access into actual paths has improved more slowly than the physical infrastructure."
---
...
**See also:** [Lessons From Rural India That Apply Globally](/kalahandi/lessons-from-rural-india), [Opportunity and Mobility in Modern India](/opportunity/opportunity-and-mobility-in-modern-india), [Opportunity Gaps: Where They Exist and Why](/opportunity/opportunity-gaps)
