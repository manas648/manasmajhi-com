...
Majhi Group runs retained searches on the same model described here — exclusive engagement, full accountability, interests aligned to quality from day one. If a VP or C-suite search has been running for more than eight weeks, [request an assessment](/work-with-me).
