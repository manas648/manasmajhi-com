...
date: "2025-07-31"
category: "hiring"
coverImage: https://images.unsplash.com/photo-1573164574572-cb89e39749b4?w=1200&q=80&auto=format&fit=crop
tags: ["hiring", "executive search", "retained search", "Majhi Group", "case study"]
featured: true
flagship: false
faqs:
  - question: "Why does retained search close faster than contingency if the upfront fee is higher?"
    answer: "The retained model removes the speed incentive that causes contingency searches to optimise for placement over quality. When the firm is paid in milestones tied to quality of process, not speed of close, they can do the work that produces defensible shortlists: thorough market mapping, structured evaluation, evidence-backed dossiers. The CEO approves fewer rounds because each shortlist is better. The process is faster because it doesn't restart from scratch after rejected batches."
  - question: "What is a 90-day replacement guarantee in executive search, and why does it matter?"
    answer: "A 90-day replacement guarantee commits the search firm to finding a replacement at no additional charge if the hired executive departs or is let go within 90 days. It matters primarily as a signal: a firm willing to stand behind their work with a replacement guarantee is a firm that believes its evaluation process is accurate. Contingency firms rarely offer it because the incentive structure doesn't require it. Retained firms who offer it are taking on real financial risk based on confidence in their process."
  - question: "How do you evaluate whether an executive search firm is genuinely running a retained process?"
    answer: "Ask four questions: Do they request an exclusive engagement? Is a portion of the fee due upfront regardless of outcome? Do they provide a structured intake brief before sourcing begins? Do candidates come with documented evidence of fit rather than just credentials? A firm calling itself retained but working without exclusivity, without upfront commitment, and without evidence-backed shortlists is running a contingency process at a higher price."
---
...
This CEO had spent 120 days trying to solve the wrong problem. The talent market was not thin. The previous firms were not incompetent. The incentive structure was wrong, and everything downstream followed from that.

>> The talent market was not thin. The previous firms were not incompetent. The incentive structure was wrong - and everything downstream followed from that.
...
Majhi Group runs retained searches on the same model described here, exclusive engagement, full accountability, interests aligned to quality from day one. If a VP or C-suite search has been running for more than eight weeks, [request an assessment](https://majhigroup.com).

**See also:** [How Executive Search Actually Works](/hiring/how-executive-search-works), [The 50-Day Executive Search](/hiring/the-50-day-executive-search), [The Cost of a Failed Executive Search](/hiring/the-cost-of-a-failed-executive-hire), [What $3,280/Month in Recruiting Tools Actually Costs You](/hiring/what-three-thousand-a-month-in-recruiting-tools-actually-costs-you)
...
[Harvard Business Review: Incentives Don't Help People Change, but Here's What Does](https://hbr.org/2022/02/incentives-dont-help-people-change-but-heres-what-does)

[LinkedIn Talent Solutions: Global Talent Trends 2024](https://business.linkedin.com/talent-solutions/global-talent-trends)
