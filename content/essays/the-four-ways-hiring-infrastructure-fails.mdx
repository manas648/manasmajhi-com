...
*The [Majhi OS research report](/whitepaper) documents these failure modes in detail, with benchmark data from 2024–25 VP-level mandate observations. If you're running a VP search and want to understand where your current search is losing candidates, a [Mission Walkthrough](https://majhi.tech) uses your actual mandate as working context.*
