...
hidden: true
faqs:
  - question: "Is AI replacing executive recruiters in 2025 and 2026?"
    answer: "AI is replacing specific tasks within executive search, sourcing, first-pass qualification, outreach drafting, but not the role itself. What AI handles well in executive search is the high-volume, pattern-matchable component: processing publicly available data to surface candidate lists, generating outreach drafts, filtering long lists against stated criteria. These were never the most valuable parts of what executive search produces. The value, and the parts where searches fail, is in the later stages: accurately assessing whether a candidate will succeed in a specific organisational context, navigating complex offer dynamics, and maintaining process integrity across months of search work."
  - question: "What can AI not do in executive search?"
    answer: "Three things AI cannot reliably do in executive search: First, assess relationship status, whether a candidate is actually available, interested, or in a conflict with a competitor that makes the approach impossible. Second, reason about organisational context, understanding what a specific hiring manager will actually respond to versus what they say they want, or recognising that the candidate who looks perfect on paper has a track record of underperforming in exactly this type of environment. Third, manage complexity across long time horizons, a VP search runs 8-16 weeks, involves shifting priorities, changing briefs, and human decisions made under uncertainty. Maintaining coherence and momentum across this arc requires judgment that current AI tools do not have."
  - question: "How is AI changing what executive recruiters need to be good at?"
    answer: "AI is raising the floor while raising the stakes on the ceiling. Recruiters who couldn't source efficiently, draft quickly, or qualify at scale are being outcompeted by those who can, and increasingly by AI tools directly. Simultaneously, the premium on what AI can't do is growing. A recruiter who can accurately assess whether a candidate will succeed in a specific organisational context, build relationships that give access to candidates not on LinkedIn, and navigate complex offer dynamics is more valuable, not less, in a market where the mechanical tasks are automated. The recruiters at risk are those who rely primarily on process execution rather than judgment."
---
