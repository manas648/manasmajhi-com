...
Remittances, money sent home by Odiyas working in other states, are a significant household income source, particularly in western and southern districts. [MOSPI research on the impact of domestic remittances](https://mospi.gov.in/sites/default/files/publication_reports/Report_The_Impact_of_Remittance.pdf) found that dependence on domestic remittances rose most sharply in Odisha from the 1990s onward, and [state migration data](https://www.humandignity.foundation/wp-content/uploads/2018/11/Odisha-State-Migration-Profile-Report.pdf) shows that rural households in districts like Bolangir, Nuapada, and Kalahandi count remittances among their primary cash income sources, with migration and remittance income accounting for more than half of annual household earnings in the most migration-intensive areas.
...
**See also:** [Beyond GDP: What a Developed Odisha Must Be Answerable For](/odisha/beyond-gdp-what-a-developed-odisha-must-be-answerable-for), [Odisha Economy: Current State and Trajectory](/odisha/odisha-economy), [Odisha's Resource Trap](/odisha/odishas-resource-trap), [Salt, Steel, and Silicon](/odisha/salt-steel-and-silicon), [The Waiting Generation](/odisha/the-waiting-generation)

---

**Sources**

[Periodic Labour Force Survey (PLFS): Ministry of Statistics and Programme Implementation](https://mospi.gov.in/web/plfs)

[The Impact of Remittances from Migrant Workers: MOSPI](https://mospi.gov.in/sites/default/files/publication_reports/Report_The_Impact_of_Remittance.pdf)
