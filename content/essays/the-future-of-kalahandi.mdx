...
>> The infrastructure makes it possible. It does not make it happen. No agricultural value chain gets built without someone deciding to build it there. No talent cluster forms without the first few people choosing to be there before the cluster exists.
