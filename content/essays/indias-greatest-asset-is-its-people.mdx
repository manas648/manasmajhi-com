...
The demographic dividend does not last forever. The fuller case for what India must do with this window is the subject of [opportunity and mobility in modern India](/opportunity/opportunity-and-mobility-in-modern-india). Countries that fail to invest in human capital during the transition often miss the window and face a different kind of demographic problem — an aging population without the economic base to support it.

>> The demographic dividend does not last forever. Countries that fail to invest in human capital during the transition miss the window — and face a different demographic problem on the other side.
