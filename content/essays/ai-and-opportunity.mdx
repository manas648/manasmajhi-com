...
flagship: false
faqs:
  - question: "Is AI distributing or concentrating opportunity?"
    answer: "Both simultaneously. AI distributes capability: making expert-level tools accessible to anyone with internet. It concentrates capital returns: the economic value flows to infrastructure owners. The balance depends on context: for someone in a low-income country developing technical skills, the distribution is real. For access to the highest-value positions, AI changes very little."
  - question: "Who benefits most from AI's distribution of capability?"
    answer: "People who develop genuine AI-amplified capabilities and position them where global demand is strongest. AI amplifies existing capability more than it substitutes for absent capability: experienced professionals gain more productivity than novices. The productivity gains are larger for those with more to amplify."
  - question: "Why do AI tools primarily benefit English-speaking, developed markets?"
    answer: "Frontier AI systems are trained predominantly on English-language data and built for high-purchasing-power markets. The best tools are most accessible to people in the most developed markets, a concentration that runs counter to the democratisation narrative. This gap is narrowing but remains significant in 2024."
---
...
Talent, after all, is evenly distributed. Opportunity is not. The question AI raises is whether it changes that equation, or simply reproduces it at higher speed.
...
**See also:** [How Opportunity Compounds Over Time](/opportunity/how-opportunity-compounds), [Opportunity Gaps: Where They Exist and Why](/opportunity/opportunity-gaps), [Opportunity in India](/opportunity/opportunity-in-india)
...
[World Bank, World Development Report 2019: The Changing Nature of Work](https://www.worldbank.org/en/publication/wdr2019)

[OECD: Artificial Intelligence and the Future of Work](https://www.oecd.org/future-of-work/)
