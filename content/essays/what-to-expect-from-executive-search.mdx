...
date: "2026-03-15"
category: "hiring"
coverImage: https://images.unsplash.com/photo-1551836022-aadb801c60ae?w=1200&q=80&auto=format&fit=crop
tags: ["executive search", "process", "partnership", "hiring", "Majhi Group"]
featured: false
hidden: true
flagship: false
faqs:
  - question: "What should a company expect from an executive search firm?"
    answer: "An executive search firm should deliver a structured process with defined milestones, not just a stream of CVs. What to hold the firm accountable for: a well-constructed brief before the search begins, a market map within the first two to three weeks showing who exists at the relevant level, a shortlist of four to six pre-qualified candidates within six to eight weeks, active candidate communication throughout, and clear guidance on offer positioning at close. What remains the company's responsibility: fast and specific feedback at each stage, access to the hiring manager for conversations, and decision-making authority that doesn't require multiple rounds of approval."
  - question: "How long does a retained executive search take?"
    answer: "A well-run retained executive search typically runs 8 to 12 weeks from signed engagement to accepted offer. Searches that take significantly longer — 16 to 20 weeks — are usually experiencing one of three problems: the brief was wrong and had to be rebuilt mid-search, the decision-making process inside the company is slow, or the offer that was ultimately made was below market. The 65 to 90-day industry median reflects these delays, not the natural timeline of a well-run search. Timeline is controlled by both sides of the engagement — most delays that occur after the shortlist is delivered sit with the client."
  - question: "What should a company bring to an executive search engagement?"
    answer: "Three things determine whether an executive search closes well. First, a real brief — not a job description, but a document articulating the business context, the specific problem the incoming leader needs to solve, and what good looks like. Second, fast feedback — the most common client-side cause of search delay. Candidates who are strong are in motion; delays in feedback cost offers. Third, decision-making authority — the clearest signal that a search will run long is a hiring committee where no single person has a mandate to make the final call. These factors are controllable before the engagement begins."
---

The search partnerships I have seen produce the best outcomes share one thing: the client understood what they were accountable for before the engagement started. Not just what they were paying for — what they needed to bring to the process. The companies that treat executive search as something that happens to them, rather than something they are participating in, almost always have worse outcomes regardless of the quality of the firm.
...
>> The search firm creates the conditions for a good decision. The company makes it.
...
The partnership works when both parties understand and stay within their respective roles.
