...
flagship: false
faqs:
  - question: "What equation did Singapore break in Manas's thinking about governance?"
    answer: "A simple one he had been carrying for years: that democratic governance and good governance were the same thing, or that you couldn't have one without the other. Singapore shows you can have highly functional institutions, world-class public housing, reliable infrastructure, a civil service that ranks among the most competent globally, without full democratic accountability. The relationship is more complex than either side of the political debate typically allows."
  - question: "What does London reveal about institution-building that most development plans miss?"
    answer: "That institutions are not designed: they accumulate. The English common law is not a blueprint; it is the output of thousands of specific disputes resolved over centuries, each resolution adding precedent that shapes the next. You cannot copy-paste an institution. You can build the conditions for one to accumulate, which is a different and substantially slower project than most development frameworks account for."
  - question: "What specific quality does rural Andhra Pradesh share with Kalahandi in how people handle constraints?"
    answer: "A matter-of-factness that is different from the resilience celebrated in motivational contexts. Less triumph over adversity, more workmanlike functioning within it. Solving the problem in front of you with the resources available, without extensive commentary on the difficulty of the situation. Manas had encountered it first in Kalahandi and recognised it when he saw it again: the same quality, a different geography."
---
...
**See also:** [What Travel Has Taught Me](/travel/what-travel-has-taught-me), [Langkawi: The Day Everything Looked Perfect](/travel/langkawi-the-day-everything-looked-perfect), [Travel as a Learning System](/travel/travel-as-a-learning-system), [Why Frequent Travelers Think Differently](/travel/why-frequent-travelers-think-differently)
...
[Freedom House, Singapore: Freedom in the World 2024](https://freedomhouse.org/country/singapore/freedom-world/2024)

[Lee Kuan Yew, From Third World to First: The Singapore Story 1965–2000](https://www.harpercollins.com/products/from-third-world-to-first-lee-kuan-yew)
