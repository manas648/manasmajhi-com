...
The research on executive hire failure is consistent and has been for decades: approximately [40% of senior leaders fail](/writing/the-cost-of-hiring-the-wrong-leader) to meet expectations within 18 months of joining. This number has not improved materially with the proliferation of recruiting tools, assessment platforms, or professional search firms.
...
The most common cause of executive hire failure is not incompetence. It is [context mismatch](/writing/have-they-done-this-before) — the placement of a capable person in an environment that requires a different kind of capability than they have developed.
