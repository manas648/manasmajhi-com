...
>> The investment has been mostly infrastructure. Infrastructure is necessary. It is not sufficient to close the economic gap. The indicators that have not moved — private sector employment, graduate retention, per capita income — are the ones that require a different kind of intervention than any government program has yet provided.
