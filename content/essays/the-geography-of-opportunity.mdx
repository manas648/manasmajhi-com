...
faqs:
  ...
  - question: "What is the first-mover problem and why is it harder than it looks?"
    answer: "The first person from a small town to reach a certain level has to act without evidence it is possible. They cannot point to anyone who looks like them and came from where they came from. They must generate belief in the absence of proof — which is a fundamentally harder task than following a path others have demonstrated. This cost is dramatically underacknowledged in the conversation about opportunity."
