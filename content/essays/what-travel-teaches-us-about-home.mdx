...
date: "2024-11-25"
category: "travel"
coverImage: https://images.unsplash.com/photo-1655920885311-9ff59799bfa3?w=1200&q=80&auto=format&fit=crop
tags: ["travel", "home", "identity", "perspective", "Odisha"]
flagship: true
hidden: true
faqs:
  - question: "What was Manas's mistake the first time he traveled outside Odisha?"
    answer: "Thinking he was going somewhere better. He was going somewhere different, which turned out to be more useful. 'Better' implies a hierarchy and positions home as lesser. 'Different' implies contrast, from which you learn something about the place you are going and something about the place you came from. The second frame is more accurate and more productive."
  - question: "Why can't you see the place you are from when you are living inside it?"
    answer: "Because familiarity renders things invisible. The features of your native landscape, its problems, its beauties, the assumptions embedded in daily life, become the texture of ordinary existence. You mistake the familiar for the natural. You navigate around things so automatically that you stop perceiving them as features at all. Contrast is what gives perception something to work with, and contrast requires a reference point that proximity cannot provide."
  - question: "What do you see when you return home after significant time elsewhere?"
    answer: "Things that were invisible because they were ambient: the specific ways things are organised differently from elsewhere, the problems that looked fixed from inside but contingent from outside, the strengths you did not recognise as strengths because they were simply normal. Returning is often the most educationally productive part of the trip: because you are finally in the place you know best, with a new set of reference points to see it through."
---
...
I spent years doing this: explaining Odisha to people who had never heard of it, explaining [Kalahandi](/kalahandi/growing-up-in-kalahandi) to people who had never heard of that, explaining what a government Odia-medium school education looks like to people whose reference points were entirely different. Every explanation was an education for me. The act of translation forced precision. I could no longer leave anything assumed.
...
>> The most useful thing travel gave me was the ability to see the gap between how things are and how things could be, and to take that gap seriously as a problem worth working on rather than a permanent condition to accept.
...
**See also:** [What Home Looks Like From Far Away](/travel/what-home-looks-like-from-far-away), [The Edited Version of Yourself](/travel/phi-phi-being-seen), [Places That Changed How I Think](/travel/places-that-changed-how-i-think)
